...
export default {
  ...
  compare: {
    ...
    pickTarget: 'Catalogue de comparaison',
    run: 'Comparer',
    hint: "La requête courante (ou la sélection) est exécutée sur les deux catalogues, puis comparée cellule à cellule. Le second catalogue passe par une connexion séparée : ces requêtes n'apparaissent pas dans le Profiler.",
    identical: 'Résultats identiques.',
    counts: '{left} : {leftCells} cellules en {leftMs} ms — {right} : {rightCells} cellules en {rightMs} ms',
    row: 'Ligne',
    column: 'Colonne',
    capped: 'Liste plafonnée à 200 écarts.',
    button: 'Comparer avec…',
    needCatalog: 'Aucun autre catalogue sur ce serveur',
  },
  sessions: {
    refresh: 'Rafraîchir',
    ...
    database: 'Catalogue',
    cpu: 'CPU',
    idle: 'Inactive depuis',
    command: 'Commande',
    commandFull: 'Cliquer pour voir la commande entière',
    commandHeader: 'Commande complète',
    commandCopied: 'Commande copiée dans le presse-papiers',
    mine: 'CubeScope',
    cancel: 'Annuler la session',
    alreadyGone: "Session {spid} déjà terminée — liste rafraîchie",
    cancelled: 'Session {spid} annulée',
    confirmHeader: 'Annuler cette session ?',
    confirmMine: "C'est la session de CubeScope. Elle sera rétablie aussitôt, sans conséquence.",
    confirmOther: "Cette session n'est pas la vôtre. L'annuler interrompt la commande en cours — s'il s'agit d'un job d'alimentation, l'étape échouera.",
  },
  editor: {
  ...
  regression: {
    ...
    saveCase: 'Enregistrer la requête comme cas',
    runAll: 'Tout exécuter',
    name: 'Nom',
    empty: 'Aucun cas enregistré',
    pass: 'OK',
    fail: 'Écart',
    summary: '{pass}/{total} OK',
